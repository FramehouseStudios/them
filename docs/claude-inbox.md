...
- Review-ready branch: `T35` iOS block-signal nudge surface consumes PR #53 `GET /memory/block-signal`.
- Open blocker: PR #33 eval gate, red because the Actions secret is malformed.

## Codex Needs Next

- Build iOS consumers for character traits and twist cards; block signal is review-ready on T35.
