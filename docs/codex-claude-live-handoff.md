...
| --- | --- | --- | --- | --- |
| T104 schema-only cleanup refresh | `codex/T104-schema-pr-cleanup-refresh` | in-progress | Closed #287/#289/#291/#292/#294 as out-of-lane schema-doc-only PRs; merged #293 after patching its Phase 7a design drift; open PRs are now only human/tier-3 gated | Start Phase 6 memories route extraction from `tasks/_proposals/T-decompose-phase6-memories-design.md`; no standalone schema-doc PRs unless Codex asks. |
