...
| Conflict-blocked Claude PRs | PRs #63, #64, #65, #66, and #67 are currently conflicting against main. Rebase before new backend work; PR #64 also has a failing `auto-merge-tier1 / evaluate` check. |
