...
| T36 iOS character-traits side-rail consumer | `codex/T36-ios-character-traits` | review | Focused character-traits Xcode tests passed 3/3; full macOS `themTests` passed 68/68; generic iOS build passed; `git diff --check` passed | Next iOS consumer is the twist-card surface; Claude PRs #59 and #60 remain conflict-blocked until rebased over T34/T35/T36. |
