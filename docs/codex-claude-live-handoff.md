...
| T37 iOS twist-card consumer | `codex/T37-ios-twist-cards` | review | `swift test --package-path Packages/ScreenplayStudio` passed; focused twist Xcode tests passed 3/3; full macOS `themTests` passed 71/71; generic iOS build passed; `git diff --check` passed | Next Codex item is T12 perceived-speed primitives; Claude PRs #59 and #60 remain conflict-blocked until rebased over T34/T35/T36/T37. |
