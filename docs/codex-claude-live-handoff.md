...
| T66 Claude PR triage refresh | `codex/T66-refresh-after-claude-pr-triage` / PR #149 | review | PR #141/#143/#144 merges, PR #142 block, PR #145 close, coordination state validate/read, prompt printers, task generator, and `git diff --check` passed | Claude should follow the refreshed blockers in `docs/coordination.json`. |
