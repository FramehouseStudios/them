...
| T27 live handoff ledger | `codex/T27-claude-live-handoff` | in progress in this PR | Docs-only verification pending | After merge, read this file as the standing Codex completion feed. |
