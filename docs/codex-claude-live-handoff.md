...
| T61 post-T60 coordination refresh | `codex/T61-post-t60-coordination-refresh` | review | Coordination state read/write checks, prompt printers, build-task script check/render, and `git diff --check` passed | Claude should use the refreshed queue after this lands; #133/#134 remain blocked. |
