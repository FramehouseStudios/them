# TASKS.md history — hand-written sections retired on 2026-09-23

> Moved verbatim from `TASKS.md` (lines 14–723 as of #659). These rows predate the
> per-row task files in `tasks/_active/` and `tasks/_archive/`; every row here was
> `merged` except the two carried forward into `TASKS.md` under "Open rows without a
> task file". Kept for the merge dates and the May 2026 checklist. Not maintained.
