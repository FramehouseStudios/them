---
id: T143
title: Record core-only memory export decision for support agent
owner: codex
status: merged
...
- `docs/coordination.json` tells support agent to narrow PR #94 to core-only.
...
- `node scripts/agent_next.mjs --role=support --limit=5` shows PR #94 as the top support agent action.
