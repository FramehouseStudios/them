...
| T-preflight-task-archive-merged                | pre-flight rule: warn when status:merged tasks linger in tasks/_active/                                    | claude | review      |
...
### T-decompose-phase7a-talk-state — Phase 7a — extract talk-state guards into backend/lib/talk_state.js
- **Owner:** claude
...
### T-preflight-task-archive-merged — pre-flight rule: warn when status:merged tasks linger in tasks/_active/
- **Owner:** claude
