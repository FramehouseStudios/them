...
- **Review note:** Implemented on `codex/T19-backend-client-craft-api` and verified on macOS plus iOS via a temporary T15 test-host merge. Rebase/check against Claude's final T18 backend contract before merge.
