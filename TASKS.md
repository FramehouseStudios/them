...
| T-realtime-supplier-failover | Transparent stub fallback when primary mint fails | claude | review |
...
| T-coordination-state-eval | Schema check on docs/coordination.json                | claude | review |
